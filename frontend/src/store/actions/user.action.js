...
import { ADD_USER_FAILED, ADD_USER_SUCCESS, CLEAR_USER, DELETE_USER_FAILED, DELETE_USER_SUCCESS, GET_RESP_VENTE_LIST_FAILED, GET_RESP_VENTE_LIST_SUCCESS, GET_USER_DATA_FAILED, GET_USER_DATA_SUCCESS, GET_USER_LIST_FAILED, GET_USER_LIST_SUCCESS, STORE_USER, UPDATE_USER_FAILED, UPDATE_USER_SUCCESS } from "./actionTypes";
...
export const getrespVenteData = (respVenteId) => async dispatch => {
  try {
    ...
    dispatch({
      type: GET_RESP_VENTE_DATA_SUCCESS,
      payload: res.data
    })
  } catch (error) {
    dispatch({
      type: GET_RESP_VENTE_DATA_FAILED,
      payload: error
    })
  }
}
...
export const getrespStockData = (respStockId) => async dispatch => {
  try {
    ...
    dispatch({
      type: GET_RESP_STOCK_DATA_SUCCESS,
      payload: res.data
    })
  } catch (error) {
    dispatch({
      type: GET_RESP_STOCK_DATA_FAILED,
      payload: error
    })
  }
}
...
export const getrespReglementData = (respReglementId) => async dispatch => {
  try {
    ...
    dispatch({
      type: GET_RESP_REGLEMENT_DATA_SUCCESS,
      payload: res.data
    })
  } catch (error) {
    dispatch({
      type: GET_RESP_REGLEMENT_DATA_FAILED,
      payload: error
    })
  }
}
