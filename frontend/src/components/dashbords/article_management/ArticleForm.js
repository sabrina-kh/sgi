		...
		<div>
			<form onSubmit={handleSubmit(onSubmit)}>
				...
				<Row>
					<Col>
						<div className="form-group my-3">
							<label>Degré d'Enfencement</label>
							<input
								name="degreEnfencement"
								type="number"
								{...register('degreEnfencement', { required: true })}
								className={`form-control ${
									errors.degreEnfencement ? 'is-invalid' : ''
								}`}
							/>
							<div className="invalid-feedback">
								{errors.degreEnfencement?.message}
							</div>
						</div>
					</Col>
					<Col>
						<div className="form-group my-3">
							...
							<input
								...
								className={`form-control ${errors.tav ? 'is-invalid' : ''}`}
							/>
				...
				<Row>
					...
					<Col>
						<div className="form-group my-3">
							...
							/>
							<div className="invalid-feedback">{errors.coefficient?.message}</div>
						</div>
					</Col>
				</Row>
				<Row>
